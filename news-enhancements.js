document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    .video-kicker{display:inline-block;margin-bottom:10px;color:#4e7d00;font-size:10px;font-weight:950;letter-spacing:.1em}
    .timi-video-copy h3{margin:0 0 12px;color:#17200f;font-size:clamp(24px,2.5vw,34px);line-height:1.08;letter-spacing:-.03em}
    .timi-video-copy p{margin:0 0 12px;color:#5d6758;font-size:14px;line-height:1.6}
    .video-intro{font-size:15px!important;color:#3f493b!important}
    .video-more-text{display:none}
    .video-description-expanded .video-more-text{display:block}
    .video-more-button{border:0;background:transparent;color:#397700;font:inherit;font-size:13px;font-weight:900;padding:5px 0;cursor:pointer;text-decoration:underline;text-underline-offset:3px}
    .video-more-button:hover{color:#17200f}
    @media(max-width:850px){
      .timi-video-feature{grid-template-columns:1fr;gap:18px;padding:14px;border-radius:20px}
      .timi-video-copy{padding:4px 6px 8px}
      .timi-video-copy h3{font-size:25px}
      .video-intro{font-size:14px!important}
    }
  `;
