  ...
  section.innerHTML = `
    <div class="container">
      ...
      <div class="options-grid premium-options">
        <article class="option-card"><div class="option-ribbon">T5</div><div class="option-label">MÍNIMO PARA LEVANTAR</div><div class="option-price"><strong>200</strong><span>USDT</span></div><div class="option-copy">Valor mínimo indicado para solicitar um levantamento na modalidade T5.</div></article>
