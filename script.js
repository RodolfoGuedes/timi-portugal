document.addEventListener('DOMContentLoaded', () => {
    ...
    header.innerHTML = `
      <div class="container nav">
        ...
        <nav class="nav-links" aria-label="Navegação principal">
          ...
          <a class="nav-telegram" href="https://www.instagram.com/portugaltimi/" target="_blank" rel="noopener noreferrer" aria-label="Abrir Instagram TIMI Portugal">Instagram</a>
        </nav>
      </div>`;
  }
  ...
  main.innerHTML = `
    ...
    <section class="section timi-video-section" id="video-apresentacao" aria-labelledby="video-apresentacao-titulo">
      <div class="container timi-video-layout">
        <div class="timi-video-copy"><span class="timi-video-kicker">CONHEÇA O PROJETO</span><h2 id="video-apresentacao-titulo">TIMI Portugal em vídeo</h2><p>Veja a apresentação do projeto antes de explorar as informações e modalidades disponíveis no site.</p><a href="https://www.youtube.com/shorts/th4d9tWlXYw" target="_blank" rel="noopener noreferrer">Ver no YouTube ↗</a></div>
        <div class="timi-video-frame"><iframe src="https://www.youtube-nocookie.com/embed/th4d9tWlXYw" title="Vídeo de apresentação da TIMI Portugal" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
      </div>
    </section>
  ...
  bottom.innerHTML = `<a href="#top"><span>⌂</span><small>Início</small></a><a href="#opcoes"><span>▣</span><small>Modalidades</small></a><a href="${telegramUrl}" target="_blank" rel="noopener noreferrer"><span>✈</span><small>Telegram</small></a><a href="https://www.instagram.com/portugaltimi/" target="_blank" rel="noopener noreferrer" aria-label="Instagram TIMI Portugal"><span>◎</span><small>Instagram</small></a><a href="${affiliateUrl}" target="_blank" rel="noopener noreferrer"><span>↗</span><small>Participar</small></a>`;
