document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('[data-affiliate]').forEach(a => { a.href = config.affiliateUrl; a.target = '_blank'; a.rel = 'noopener noreferrer'; });
  document.querySelectorAll('[data-telegram]').forEach(a => { a.href = config.telegramUrl; a.target = '_blank'; a.rel = 'noopener noreferrer'; });
